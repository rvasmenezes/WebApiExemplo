...
namespace Lider.DPVAT.APIModelo.UI.Extension
{
    public static class SwaggerGenOptionsExtensions
    {
        ...
        public static void ConfigureSwaggerGenOptions(this SwaggerGenOptions options, IConfiguration configuration)
        {
            ...
            {
                Title = $"Example API Project - { configuration.GetSection("AmbienteConfiguration:Nome").Value }",
                Version = configuration.GetSection("Versao").Value,
                Description = "API de exemplo para o desenvolvimento de outras API.",
                Contact = new Contact()
                {
